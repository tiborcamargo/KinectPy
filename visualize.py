...
parser.add_argument("-n", "--n_frames", help="number of loaded point clouds", type=int, default=100)
args = parser.parse_args()


if __name__ == '__main__':
    
    print(f'Displaying only {args.n_frames} frames.')
    root_dir = args.dir
    ...
    pcd_filenames = sort_filenames_by_timestamp(os.listdir(pcd_dir))[:args.n_frames]
